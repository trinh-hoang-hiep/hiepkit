from ..vws.Node import Node
from ..vws.Utils import Utils
from ..vws.FWObject import FWObject
from ..vws.WordTag import WordTag
from ..vws.Vocabulary import Vocabulary
    ...
    def __init__(self, model_path=None, vocab_path=None):
        ...
        try:
            if model_path is None:
                ...
                self.constructTreeFromRulesFile(model_path)
...
if __name__ == "__main__":
    ...
    output = rdrsegment.segmentRawSentences(tokenizer,
                                            "Lượng khách Thái bắt đầu gia tăng từ đầu năm 2005. Bên cạnh đó, kể từ tháng 10-2005 đến nay, từ khi được phép của VN, các đoàn caravan của Thái Lan cũng đã ồ ạt đổ vào VN.")
